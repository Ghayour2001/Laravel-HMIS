                      ...
                      <table id="basic-table" class="table table-striped mb-0" role="grid">
                         ...
                         <tbody>
                            <tr>
                               <td>
                                  <div class="d-flex align-items-center">
                                     <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('assets/auth/')}}images/shapes/01.png" alt="profile">
                            ...
                            <tr>
                               <td>
                                  <div class="d-flex align-items-center">
                                     <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('assets/auth/')}}images/shapes/05.png" alt="profile">
                            ...
                            <tr>
                               <td>
                                  <div class="d-flex align-items-center">
                                     <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('assets/auth/')}}images/shapes/02.png" alt="profile">
                            ...
                            <tr>
                               <td>
                                  <div class="d-flex align-items-center">
                                     <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('assets/auth/')}}images/shapes/03.png" alt="profile">
                            ...
                            <tr>
                               <td>
                                  <div class="d-flex align-items-center">
                                     <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('assets/auth/')}}images/shapes/04.png" alt="profile">
