...
@section('content')
    <div class="row">
        <div id="insertFormDiv" style="display: none; margin-bottom:100px;">
            <div class="container-fluid pt-3 bg-white shadow">
                <h4 class="pb-3 pl-4">ADD STAFF</h4>
        ...
        <div class="card-body" id="dataTable" style="margin-bottom:100px;">
            <div class="parent-div d-flex justify-content-between align-items-center pb-5">
                ...
                <button type="button" id="addButton" class="btn btn-primary me-2">
                    Add New
                </button>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-container">
                        <div id="responseMessage" class="alert w-25" role="alert"></div>
        ...
        <div id="editDiv" style="display: none; margin-bottom:100px;">
            <div class="container-fluid pt-3 bg-white shadow">
                <h4 class="pb-3 pl-4">UPDATE STAFF</h4>
                <hr class="beautiful-line">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == 0) {
                                return '<span class="badge bg-danger p-2 w-100">Inactive</span>';
                            } else if (data == 1) {
                                return '<span class="badge bg-success p-2 w-100">Active</span>';
                            } else {
                                return '';
                            }
                        }
