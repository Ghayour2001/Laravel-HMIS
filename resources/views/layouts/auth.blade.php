...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/auth/css/hope-ui.min.css?v=2.0.0') }}" />

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{ asset('assets/auth/css/custom.min.css?v=2.0.0') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('assets/auth/vendor/chosen-js/chosen.css') }}" />
    ...
    <style>
        ...
        /* Center the bed text and make it responsive */
        .bed-name {
            font-size: 12px;
            white-space: nowrap;
            overflow: hidden;
        ...
        .single-bed .bed-green i {
            font-size: 3rem;
            text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);
            transform: rotateX(20deg);
        }

        .single-bed .bed-red i {
            font-size: 3rem;
            text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);
            transform: rotateX(20deg);
        }

        /* Additional CSS for improving icon visibility */
        .single-bed .bed-red i {
            color: red;
        }
        ...
        .parent-div {
            position: relative;
            /* Ensure the button is positioned relative to this div */
            padding-right: 40px;
            /* Add some padding on the right to make space for the button */
        }
        ...
        /* Styles for the animated icon */
        .animated-icon {
            font-size: 40px;
            /* Adjust the icon size as needed */
            margin-right: 20px;
            /* Add spacing between the icon and the message */
        }

        /* Styles to center the icon vertically */
        .animated-icon i {
            line-height: 300px;
            /* Vertically center the icon */
        }

        /* Styles to animate the icon (optional) */
        @keyframes spin {
            0% {
                transform: rotate(0deg);
            }
        ...
        .main-content {
            /* Set the height of the content area so the footer doesn't overlap it */
            min-height: calc(75% - 50px);
            /* You can adjust the value as needed */
            padding-bottom: 50px;
            margin-bottom: 20px;
            /* Set a padding equal to the footer height to push the content above the footer */
        }
        ...
        /* Show the popover content on hover */
        ...
        .popover {
            position: absolute;
            bottom: 100%;
            /* Position the popover above the container */
            left: 50%;
            ...
            /* Add any other styles you want for the popover here */
        }

        /* Show the popover when hovering over the container */
        .single-bed:hover .popover {
            display: block;
        }
    </style>
</head>
...
<body class="">
    ...
    <!-- loader END -->
    <main class="main-content hide-main-footer" id="show-main-content">
        <!--Nav Start-->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto  navbar-list mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <button type="button" id="show-beds-modal-btn" class="nav-link btn btn-primary"
                                data-bs-toggle="modal" data-bs-target="#bedModal">
                                <i class="fas fa-bed"></i> Bed Status
                            </button>

                            {{-- <a href="#" class="search-toggle nav-link" id="dropdownMenuButton2"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{ asset('assets/auth/images/Flag/flag001.png') }}"
                                    ...
                                    <div class="card-body p-0">
                                        <a href="#" class="iq-sub-card">
                                            <div class="d-flex align-items-center">
                                                <img class="avatar-40 rounded-pill bg-soft-primary p-1"
                                                    src="{{ asset('assets/auth/images/shapes/01.png') }}"
                                                    alt="">
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded-pill bg-soft-primary p-1"
                                                        src="{{ asset('assets/auth/images/shapes/02.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="d-flex align-items-center">
                                                <img class="avatar-40 rounded-pill bg-soft-primary p-1"
                                                    src="{{ asset('assets/auth/images/shapes/03.png') }}"
                                                    alt="">
                                                <div class="ms-3 w-100">
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="d-flex align-items-center">
                                                <img class="avatar-40 rounded-pill bg-soft-primary p-1"
                                                    src="{{ asset('assets/auth/images/shapes/04.png') }}"
                                                    alt="">
                                    ...
                                    <div class="card-body p-0 ">
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img class="avatar-40 rounded-pill bg-soft-primary p-1"
                                                        src="{{ asset('assets/auth/images/shapes/05.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="ms-3">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown"
                                ...
                                <img src="{{ asset('assets/auth/images/avatars/01.png') }}" alt="User-Profile"
                                    class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                                <img src="{{ asset('assets/auth/images/avatars/avtar_1.png') }}" alt="User-Profile"
                                    class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded">
                                <img src="{{ asset('assets/auth/images/avatars/avtar_2.png') }}" alt="User-Profile"
                                    class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded">
                                <img src="{{ asset('assets/auth/images/avatars/avtar_4.png') }}" alt="User-Profile"
                                    class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded">
                                <img src="{{ asset('assets/auth/images/avatars/avtar_5.png') }}" alt="User-Profile"
                                    class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded">
                                <img src="{{ asset('assets/auth/images/avatars/avtar_3.png') }}" alt="User-Profile"
        ...
        <div class="navbar dual-horizontal" style="z-index: 700 !important;">
            ...
            <nav id="navbar_main"
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link " href="{{ route('patient.index') }}"> OPD
                            </a></li>
                            <li class="nav-item"><a class="nav-link " href="{{ route('ipd.index') }}"> IPD </a></li>
                        <li class="nav-item"><a class="nav-link " href="{{ route('user.index') }}"> Users
                            </a></li>
                        <li class="nav-item"><a class="nav-link active"
                                href="../dashboard/index-dual-horizontal.html"> Dual Horizontal </a></li>
                        <li class="nav-item"><a class="nav-link " href="../dashboard/index-dual-compact.html"><span
                                    class="item-name">Dual Compact</span></a></li>
                        <li class="nav-item"><a class="nav-link " href="{{ route('insurance.index') }}"> Insurance Management </a></li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li>
                                    <a class="dropdown-item" href="{{ route('symptom.index') }}">Symptoms</a>
                                </li> <li>
                                    <a class="dropdown-item" href="{{ route('bed.index') }}">Beds</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ route('position.index') }}">Role</a>
                                </li>
                                {{-- <li>
    ...
    {{-- all beds modal div start --}}
    <div class="hide show-all-bed-modal" id="show-beds-modal-div">

    </div>

    @yield('extra-content')
    <!-- Footer Section Start -->
    <footer class="footer hide-main-footer" id="show-footer">
        ...
        <div class="offcanvas-body data-scrollbar">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div class="text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/03.png') }}images/settings/dark/03.png"
                            ...
                            <img src="{{ asset('assets/auth/images/settings/light/03.png') }}images/settings/light/03.png"
                                alt="mini" class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                            <span class="mt-2">Mini</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/04.png') }}images/settings/dark/04.png"
                            ...
                            <img src="{{ asset('assets/auth/images/settings/light/04.png') }}" alt="hover"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover"
                                data-extra-value="sidebar-mini">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/05.png') }}" alt="boxed"
                            ...
                            <img src="{{ asset('assets/auth/images/settings/light/05.png') }}" alt="boxed"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/06.png') }}" alt="rounded-one-side"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-item" data-value="navs-rounded">
                            <img src="{{ asset('assets/auth/images/settings/light/06.png') }}" alt="rounded-one-side"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                            <span class="mt-2">Rounded One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/07.png') }}" alt="rounded-all"
                                class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <img src="{{ asset('assets/auth/images/settings/light/07.png') }}" alt="rounded-all"
                                class="mode light-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <span class="mt-2">Rounded All</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/08.png') }}" alt="pill-one-side"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-item" data-value="navs-pill">
                            <img src="{{ asset('assets/auth/images/settings/light/09.png') }}" alt="pill-one-side"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                            <span class="mt-2">Pill One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/09.png') }}" alt="pill-all"
                            ...
                            <img src="{{ asset('assets/auth/images/settings/light/08.png') }}" alt="pill-all"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 ">
                        <div class=" text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/11.png') }}" alt="image"
                            ...
                            <img src="{{ asset('assets/auth/images/settings/light/10.png') }}" alt="image"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                            <span class="mt-2">Glass</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/10.png') }}" alt="color"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                            <img src="{{ asset('assets/auth/images/settings/light/11.png') }}" alt="color"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                            <span class="mt-2">Color</span>
                        </div>
                        <div class=" text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/12.png') }}" alt="sticky"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                            <img src="{{ asset('assets/auth/images/settings/light/12.png') }}" alt="sticky"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                            <span class="mt-2">Sticky</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('assets/auth/images/settings/dark/13.png') }}" alt="transparent"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
                            <img src="{{ asset('assets/auth/images/settings/light/13.png') }}" alt="transparent"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
    ...
    <script src="{{ asset('assets/auth/vendor/chosen-js/chosen.jquery.js') }}"></script>
    <script>
        $(document).ready(function() {
            ...
            $(".chosenSelect").chosen({
                placeholder_text_multiple: "Select Symptoms",
                no_results_text: "No matching symptom found",
    ...
    <script>
        $(document).ready(function() {
            $('#show-beds-modal-btn').click(function() {


                // Make the AJAX call when the button is clicked
                $.ajax({
                    url: '/getallbeds',
                    type: 'GET',
                    success: function(response) {
                        // Insert the fetched HTML into the modal div
                        $('#show-beds-modal-div').html(response);
                        $('.hide-main-footer').hide();
                        $('#show-beds-modal-div').show();
                    },
            ...
            $('#show-beds-modal-div').on('click', '#close-beds-modal-btn', function() {
                $('.hide').hide();
                $('#show-main-content').show();
                $('#show-footer').show();
            });
            $(document).on('click', '.single-bed', function() {
                var bed_Id = $(this).data('bed_id');
                var bedgroup_Id = $(this).data('bedgroup_id');

                // alert(bedgroup_Id);
                window.location = "/user#30" + bed_Id + "#90" + bedgroup_Id;
            });
